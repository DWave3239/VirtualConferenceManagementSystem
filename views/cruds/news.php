...
<table class="table table-sm">
    ...
    {loop="$list"}
        <tr>
            ...
            <td>
                <a href="{$_base_}backend/{$url}/edit/{$value.newsId}" class="btn btn-primary">Edit</a>
                <a href="#" data-href="{$_base_}backend/{$url}/delete/{$value.newsId}" class="btn btn-primary" data-toggle="modal" data-target="#crudDeletionOverlay">Delete</a>
            </td>
        </tr>
    {/loop}
    </tbody>
